...
public class ShiroConfiguration {
    ...
    /** 
     * <dt><span class="strong">方法描述:</span></dt><dd>方法没有实现</dd>
     * <dt><span class="strong">作者:</span></dt><dd>weijx</dd>
     * <dt><span class="strong">时间:</span></dt><dd>2017年11月20日 下午6:51:23</dd>
     * @return
     * @since v1.0
    */
    @Bean
    public CacheManager getCacheManager() {  
//        EhcacheManager em = new EhcacheManager(config);
